          ...
          <div className="flex flex-col items-center gap-y-20 gap-x-16 lg:flex-row-reverse lg:justify-between">
            ...
            <div className="hero-image flex-center relative overflow-hidden rounded-full aspect-square p-[3px] 3xl:p-[3.5px] 6xl:p-[4px]  w-[88%] 3xl:w-full max-w-[315px] 3xl:max-w-[350px] 6xl:max-w-[380px]">
              <div className="bg-primary flex-center overflow-hidden rounded-full size-full transition-500 z-10">
                <Image src="/profile-pic.jpg" alt="profile-pic" fill className="object-cover rounded-full scale-96" />
              </div>
            </div>
            ...
            <div className="sm:text-center lg:text-left">
              ...
              <h1 className="text-primary mt-2 text-5xl 3xl:text-6xl 6xl:text-[65px]">
                I'm<i className="text-gradient pl-1">Nicholas</i>
              </h1>
          ...
          <div className="mx-3 text-center grid gap-8 md:grid-cols-2 3xl:gap-16">
            ...
            <div className="about card-animation">
              <div className="content bg-secondary-card py-7 px-5">
                ...
                <p className="font-medium text-sm md:text-[15px] 3xl:text-base 6xl:text-[17px]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi assumenda suscipit sequi sint pariatur
                  earum distinctio itaque dicta placeat ipsam, corporis vero, ea non odit repudiandae dignissimos?
                  Suscipit quia esse mollitia? Architecto consequuntur error quisquam nam tenetur, velit laborum quae?
                  Hic unde quasi maxime accusantium quis quaerat, voluptatibus odio praesentium voluptate?
                </p>
              </div>
            </div>
            ...
            <div className="about card-animation">
              <div className="content bg-secondary-card py-7 px-5">
                ...
                <p className="font-medium text-sm md:text-[15px] 3xl:text-base 6xl:text-[17px]">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam nobis vitae quasi repellendus est
                  inventore! Atque modi, ab sunt voluptate facilis, pariatur aliquid maiores fuga nostrum tenetur
                  deserunt adipisci Aut, modi autem iure nisi eaque perferendis voluptas provident, dolor veritatis
                  architecto minima cupiditate recusandae nam, repellat ipsam odit iusto. Odio, et quos. Nemo,
                  veritatis.
                </p>
              </div>
            </div>
